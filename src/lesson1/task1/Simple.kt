 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = (initial+(initial/100.0*percent)+(((initial+(initial/100.0*percent))/100.0)*percent))+((initial+(initial/100.0*percent)+(((initial+(initial/100.0*percent))/100.0)*percent))/100*percent)
/**
 * Простая
 *
